...
optionListFile 	<- read.csv(file = "/usr/local/src/shiny/optionList.txt", header = TRUE)
optionQuant <- read.csv(file = "/usr/local/src/shiny/optionQuantity.csv", header = TRUE)
optionQuant$code <- str_pad(optionQuant$code,width=4, side="left", pad="0")
